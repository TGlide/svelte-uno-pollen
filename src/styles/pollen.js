export default {
	...
	scaleFluid: {
		0: 'clamp(0.875rem, 0.8rem + 0.25vw, 1rem)',
		1: 'clamp(1rem, 0.925rem + 0.25vw, 1.125rem)',
		2: 'clamp(1.125rem, 1.05rem + 0.25vw, 1.25rem)',
		3: 'clamp(1.25rem, 1.1rem + 0.5vw, 1.5rem)',
		4: 'clamp(1.5rem, 1.275rem + 0.75vw, 1.875rem)',
		5: 'clamp(1.875rem, 1.65rem + 0.75vw, 2.25rem)',
		6: 'clamp(2.25rem, 1.8rem + 1.5vw, 3rem)',
		7: 'clamp(3rem, 2.55rem + 1.5vw, 3.75rem)',
		8: 'clamp(3.75rem, 3.3rem + 1.5vw, 4.5rem)',
		9: 'clamp(4.5rem, 3.6rem + 3vw, 6rem)',
		10: 'clamp(6rem, 4.8rem + 4vw, 8rem)',
	...
	line: { none: 1, xs: 1.125, sm: 1.275, md: 1.5, lg: 1.625, xl: 2 },
	letter: { xs: '-0.05em', sm: '-0.025em', none: '0em', lg: '0.025em', xl: '0.05em' },
	prose: { xs: '45ch', sm: '55ch', md: '65ch', lg: '75ch', xl: '85ch' },
	size: {
		1: '4px',
		2: '8px',
		3: '12px',
	...
	width: { xs: '480px', sm: '640px', md: '768px', lg: '1024px', xl: '1280px' },
	ratio: {
		square: '1/1',
		portrait: '3/4',
		landscape: '4/3',
	...
	radius: { 100: '100%', xs: '3px', sm: '6px', md: '8px', lg: '12px', xl: '16px', full: '9999px' },
	blur: { xs: 'blur(4px)', sm: 'blur(8px)', md: 'blur(16px)', lg: 'blur(24px)', xl: 'blur(40px)' },
	layer: { 1: 10, 2: 20, 3: 30, 4: 40, 5: 50, below: -1, top: 2147483647 },
	shadow: {
